...
export const FAQ_DATA: Record<'nl' | 'en', FaqItem[]> = {
  nl: [
    { q: 'Is dit toegestaan volgens het beleid van Google?', a: 'ReviewShield vraagt intern om feedback voordat iemand wordt uitgenodigd voor een publieke review. Je bepaalt zelf wie je uitnodigt, net als bij een persoonlijke follow-up. Veel gevestigde reputatie-tools werken op dezelfde manier. Belangrijk is dat je niemand verhindert die al actief naar een reviewpagina onderweg was.' },
    ...
    { q: 'Hoe kan ik opzeggen?', a: 'Opzeggen doe je via een simpele mail naar opzeggen@reviewshield.nl. Geen formulieren, geen gedoe, geen opzegtermijn. Het abonnement stopt aan het einde van de lopende maand.' },
    ...
    { q: 'Wat gebeurt er na de proefperiode als ik niets doe?', a: 'Na 14 dagen starten we de eerste automatische incasso voor het gekozen pakket. Je ontvangt hier een herinnering per e-mail vóórdat dit gebeurt. Wil je niet doorgaan, stuur dan vóór het einde van de proefperiode een mail naar opzeggen@reviewshield.nl.' },
  ...
  en: [
    ...
    { q: 'How do I cancel?', a: 'Cancel by sending a simple email to cancel@reviewshield.nl. No forms, no hassle, no notice period. The subscription stops at the end of the current month.' },
    { q: 'Can I cancel at any time?', a: 'Yes. You can cancel at any time by email. You retain access until the end of the paid month.' },
    { q: "What happens after the trial if I don't do anything?", a: "After 14 days we start the first automatic payment for the chosen package. You'll receive a reminder by email before this happens. If you don't want to continue, send an email to cancel@reviewshield.nl before the end of the trial period." },
